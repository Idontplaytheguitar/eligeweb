...
export default function AdminCursosPage() {
  ...
  const handleDelete = async (id: string) => {
    if (!confirm("¿Eliminar este taller? Las ventas registradas se borrarán también.")) return;
    try {
      ...
      <div className="border-b bg-header">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-xl font-bold">Talleres</h1>
          </div>
          <Button
            onClick={() => {
              setCurrent({
            ...
            <CardContent className="py-4 flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-amber-800 dark:text-amber-300">
                  Para poder cobrar los talleres, conectá tu cuenta de MercadoPago desde la página
                  de configuración.
                </p>
              </div>
        ...
        {courses.length === 0 ? (
          <Card>
            <CardContent className="py-12 text-center">
              <p className="text-muted-foreground mb-4">No hay talleres todavía</p>
              <Button
                onClick={() => {
                  setCurrent({
                    title: "",
                ...
                <CardHeader className="pb-2">
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <div className="flex items-center gap-1">
                      {c.published && (
                        <Button variant="ghost" size="icon" asChild title="Ver taller">
